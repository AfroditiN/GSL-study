...
full_test <- full_test %>% 
  mutate(response = if_else(word_type > 2, rand_keys[1], rand_keys[2])) %>%
...
instr_stim = paste("<p>?????? ???????????????????????? ?????? ???????????????????????? ???? ?????????????????????? ????????????.</p>",
                   "<p>?????? ???????????????? ?????????????????? ???? ?????????? ?????? ???????????? ???? ?????????????? ?????? ???????????????????? ?????? ???????? ?????? ????????????,</p>",
                   "<p>?????? ???????????? ???????? ???? ???????????????????? ???????? ?????????? ??????.</p>",
                   "<p>???? ???????????? ???? ?????????????????????? ?????? ?????? ?????????????? ????????????????, ?????? ?? ???????????? ???????? ?????????? ???????????????????? ???????? ?? ??????.",
                   "<p>?????????????? <span style='color:red;font-size:24pt;line-height:normal'>", rand_keyboard[1], 
                   "</span>?????? ???????????????????????? ?????? ?????? ???????????????? ?????? ?????? ?????????? ???????????????????? ????????.</p>",
                   "<p>???????????? <span style='color:red;font-size:24pt;line-height:normal'>", rand_keyboard[2],
                   "</span>?????? ???????????????????????? ?????? ?????? ???????????????? ?????? ?????????? ???????????????????? ????????</p>")
